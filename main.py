...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=110, help='Batch size for training (default: 110)')
    ...
    parser.add_argument('--conv_algo', type=int, default=2, choices=[0,1,2], help='Conv2d algorithm 0-direct, 1-im2col, 2-im2colfused (default: 2)')
